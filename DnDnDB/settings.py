"""
Django settings for DnDnDB project.
...
DATABASES = {
    'default': {
        ...
        'NAME':  os.environ.get("DNDNDB_NAME"),
        'USER': os.environ.get("DNDNDB_USER"),
        'PASSWORD': os.environ.get("DNDNDB_PASSWORD"),
        'HOST': os.environ.get("DNDNDB_HOST"),
        'PORT': os.environ.get("DNDNDB_PORT"),
    }
}
